...
import { DrAmbulanceWlEditor } from '../dr-ambulance-wl-editor';
...
describe('dr-ambulance-wl-editor', () => {
  ...
  it('buttons shall be of different type', async () => {
    ...
    const page = await newSpecPage({
      components: [DrAmbulanceWlEditor],
      html: `<dr-ambulance-wl-editor entry-id="test-entry"
      ambulance-id="test-ambulance" api-base="http://sample.test/api"></dr-ambulance-wl-editor>`,
    });
    await delay(300);
  ...
  it('first text field is patient name', async () => {
    ...
    const page = await newSpecPage({
      components: [DrAmbulanceWlEditor],
      html: `<dr-ambulance-wl-editor entry-id="test-entry" ambulance-id="test-ambulance" api-base="http://sample.test/api"></dr-ambulance-wl-editor>`,
    });
